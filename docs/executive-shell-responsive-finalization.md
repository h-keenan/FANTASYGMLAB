...
- Desktop (1024 / 1280): executive content max `1360px` (viewport still caps)
- Wide (1440): `1520px` content contract
- Ultrawide (1600+ / 1800): centered `1680px` ultra contract — content does not
