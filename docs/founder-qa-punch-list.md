...
| FQA-003 | Dashboard, 320px | Supporting sentences under Immediate Action and Your Next Move remain close in visual weight. | Extra scan friction. | PR #99 screenshots | Typography hierarchy — **resolved in workflow compression** (eyebrows/subtitles removed; denser section rhythm) |
