...
def test_command_bar_uses_content_aware_columns_and_shared_control_metrics():
    ...
    assert "height: 100% !important" in EXECUTIVE_COMMAND_HEADER_CSS
    assert "min-height: var(--touch-target-min) !important" in EXECUTIVE_COMMAND_HEADER_CSS
    assert "padding-inline: var(--space-sm) !important" in EXECUTIVE_COMMAND_HEADER_CSS
