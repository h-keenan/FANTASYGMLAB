...
export const PLAYER_TIER_LADDER: PlayerTierIdentity[] = [
  { tierId: 'generational', semanticLabel: 'Generational', shortLabel: 'GENERATIONAL', rankOrder: 1, color: '#67E8F9' },
  { tierId: 'elite', semanticLabel: 'Elite', shortLabel: 'ELITE', rankOrder: 2, color: '#8B93FF' },
  { tierId: 'impact_starter', semanticLabel: 'Impact Starter', shortLabel: 'IMPACT STARTER', rankOrder: 3, color: '#EF4444' },
  { tierId: 'starter', semanticLabel: 'Starter', shortLabel: 'STARTER', rankOrder: 4, color: '#D8B85A' },
  { tierId: 'contributor', semanticLabel: 'Contributor', shortLabel: 'CONTRIBUTOR', rankOrder: 5, color: '#D7DBE2' },
  { tierId: 'committee_role', semanticLabel: 'Committee / Role', shortLabel: 'COMMITTEE/ROLE', rankOrder: 6, color: '#F59E0B' },
  { tierId: 'depth_developmental', semanticLabel: 'Depth / Developmental', shortLabel: 'DEPTH/DEV', rankOrder: 7, color: '#626A75' },
];
