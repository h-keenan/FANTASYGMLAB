...
""" + FOOTBALL_ASSET_CSS + LEAGUE_INTELLIGENCE_CSS + RECOMMENDATION_TRUST_CSS + COMMAND_CENTER_CSS + PLAYER_QUICK_VIEW_CSS + INTERFACE_REIMAGINING_CSS + MOBILE_WORKFLOW_CSS + FOUNDER_BETA_CONSISTENCY_CSS + TRADE_DETAIL_CSS + FOUNDER_BETA_QUICK_FIX_CSS + BRAND_IDENTITY_CSS + VISUAL_HIERARCHY_CSS + DESKTOP_EXECUTIVE_LAYOUT_CSS + EXECUTIVE_WORKFLOW_COMPRESSION_CSS + EXECUTIVE_DESIGN_UNIFY_CSS + """
</style>
"""
