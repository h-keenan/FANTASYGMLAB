...
PLATFORM_DESTINATIONS: Tuple[PageDefinition, ...] = (
    ...
    PageDefinition("trade_hub", "Trade Hub", "TRANSACTIONS", "Primary trade discovery workspace for team-wide and player-centered paths.", category="CORE", beta_visible=True),
    PageDefinition("trade_analyzer", "Trade Analyzer", "TRANSACTIONS", "Exact package builder and evaluator for specific offers.", category="EXPERIMENTAL"),
