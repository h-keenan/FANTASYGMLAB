...
.methodology-factor-grid,
.methodology-strategy-list {
    display: grid;
    gap: var(--space-sm);
...
.methodology-faq-item summary::-webkit-details-marker {
    display: none;
}
.methodology-faq-item[open] summary {
    margin-bottom: var(--space-xs);
}
.methodology-limits {
    border-left: var(--border-width-semantic) solid var(--border-accent);
