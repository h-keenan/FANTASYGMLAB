...
.player-dossier-rank-strip{display:grid;gap:var(--space-sm);grid-template-columns:repeat(4,minmax(0,1fr));margin:var(--space-sm) 0;padding:0}
.player-dossier-rank-cell{display:grid;gap:var(--space-2xs);min-width:0}
.player-dossier-rank-cell span,.pqv-signal-badge-question,.pqv-why-factor span,.pqv-recommendation-confidence{color:var(--color-text-muted);font-size:var(--font-size-badge);letter-spacing:var(--letter-spacing-badge);text-transform:uppercase}
.player-dossier-rank-cell strong,.pqv-signal-badge-answer,.pqv-why-factor strong{color:var(--color-text-primary);font-size:var(--font-size-body);overflow-wrap:anywhere}
.player-dossier-rank-strip-value{color:var(--color-text-muted);font-size:var(--font-size-badge)}
.pqv-signal-badge-group{display:flex;flex-wrap:wrap;gap:var(--space-sm);margin:var(--space-sm) 0 0}
.pqv-signal-badge{border-left:var(--border-width-semantic) solid var(--color-border-strong);display:grid;gap:var(--space-2xs);min-width:0;padding-left:var(--space-sm)}
.pqv-why-recommendation{margin:0}
.pqv-why-grid{display:grid;gap:var(--space-sm)}
.pqv-accolades{margin:var(--space-sm) 0}
.pqv-accolade-cluster{display:flex;flex-wrap:wrap;gap:var(--space-sm);list-style:none;margin:0;padding:var(--space-sm) var(--space-md) var(--space-sm)}
.pqv-accolade{align-items:center;background:var(--color-surface-muted);border:var(--border-width-default) solid var(--color-border);border-left:var(--border-width-semantic) solid var(--color-prestige-contributor);display:flex;gap:var(--space-sm);min-height:var(--touch-target-min);min-width:9.5rem;padding:var(--space-xs) var(--space-sm)}
.pqv-accolade--gold{border-left-color:var(--color-prestige-elite);color:var(--color-prestige-elite)}
.pqv-accolade--silver{border-left-color:var(--color-prestige-starter);color:var(--color-prestige-starter)}
.pqv-accolade--bronze{border-left-color:var(--color-prestige-contributor);color:var(--color-prestige-contributor)}
.pqv-accolade--plain{border-left-color:var(--color-border-strong);color:var(--color-text-secondary)}
.pqv-accolade-medal{flex:0 0 1.35rem;height:1.5rem;width:1.35rem}
.pqv-accolade-copy{display:grid;gap:var(--space-2xs);min-width:0}
.pqv-accolade-copy strong{color:var(--color-text-primary);font-size:var(--font-size-body);line-height:var(--line-height-card);overflow-wrap:anywhere}
.pqv-accolade-copy small{color:var(--color-text-muted);font-size:var(--font-size-badge);letter-spacing:var(--letter-spacing-badge)}
.pqv-accolades-more{margin:0 var(--space-md) var(--space-sm)}
.pqv-accolade-cluster--all{padding-left:0;padding-right:0}
...
.player-dossier-career-summary{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}
.player-dossier-career-metric{border-bottom:var(--border-width-default) solid var(--color-border);border-right:var(--border-width-default) solid var(--color-border);display:grid;gap:var(--space-2xs);min-width:0;padding:var(--space-sm) var(--space-md)}
...
div[data-testid="stDialog"] .player-quick-view-avatar{height:clamp(4.25rem,16vw,6rem) !important;width:clamp(4.25rem,16vw,6rem) !important}
...
.player-dossier-snapshot-title,.player-dossier-section-heading{border-bottom:var(--border-width-default) solid var(--color-border);border-left:var(--border-width-semantic) solid var(--color-border-strong);padding:var(--space-sm) var(--space-md)}
...
.player-dossier-rank-strip{grid-template-columns:repeat(2,minmax(0,1fr))}
.player-dossier-career-summary{grid-template-columns:1fr}
.player-dossier-career-metric{border-right:0}
