...
[class*="dashboard_deep_analysis_nav"] [data-testid="stButton"] button{background:var(--color-surface-raised)!important;border:var(--border-width-default) solid var(--color-border)!important;border-radius:4px!important;color:var(--color-text-secondary)!important;font-size:var(--font-size-badge)!important;min-height:var(--touch-target-min)!important;padding:var(--space-xs) var(--space-sm)!important;text-align:center!important;text-transform:uppercase!important;white-space:nowrap!important}
