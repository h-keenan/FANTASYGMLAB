...
.fgl-landing{box-sizing:border-box;color:var(--color-text-primary,#e5e7eb);display:flex;flex-direction:column;gap:.65rem;margin:0 auto .85rem;max-width:min(42rem,calc(100vw - 1.5rem));min-width:0;width:100%}
...
.fgl-landing__trust{color:var(--color-text-muted,rgba(148,163,184,.95));font-size:.8rem;line-height:1.35;margin:.1rem 0 0;max-width:34rem}
.fgl-landing__preview{display:grid;gap:.3rem;list-style:none;margin:.2rem 0 0;max-width:34rem;padding:0}
.fgl-landing__preview-item{display:grid;gap:.05rem}
.fgl-landing__preview-item strong{color:var(--color-text-primary,#f8fafc);font-size:.82rem;font-weight:700}
.fgl-landing__preview-item span{color:var(--color-text-secondary,rgba(203,213,225,.9));font-size:.78rem;line-height:1.35;overflow-wrap:anywhere}
...
.fgl-landing__kicker{color:var(--color-text-muted,rgba(148,163,184,.95));font-size:.68rem;font-weight:750}
...
.fgl-landing{max-width:calc(100vw - 1.25rem);margin-inline:auto}
.fgl-landing__value{font-size:clamp(1.12rem,5vw,1.32rem);overflow-wrap:break-word;word-break:normal;hyphens:none}
}
@media (min-width:900px){
.fgl-landing{max-width:44rem}
.fgl-landing__hero-grid{grid-template-columns:minmax(0,1fr);align-items:start}
