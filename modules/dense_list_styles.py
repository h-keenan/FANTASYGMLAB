...
@media (min-width:901px){.dg-team-comparison-board .dg-ranked-row.dg-dense-row{align-items:center;grid-template-columns:auto minmax(12rem,1.2fr) minmax(6.5rem,8rem) minmax(16rem,1.4fr)}.dg-team-comparison-board .dg-dense-metric{align-content:center;justify-items:start}.dg-team-comparison-board .dg-dense-metric__label{text-align:left}.dg-team-comparison-board .dg-dense-trail{align-content:center;overflow:visible}.dg-team-comparison-board .dg-dense-status,.dg-team-comparison-board .dg-dense-meta{overflow:visible;white-space:normal}}
""".strip()
