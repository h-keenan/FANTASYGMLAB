...
.dg-team-comparison-state,.dg-team-comparison-tendencies,.dg-team-comparison-activity{display:grid;gap:1px;min-width:0}
...
@media (max-width:640px){.dg-ranked-row.dg-dense-row{gap:var(--space-2xs) var(--space-xs);grid-template-areas:"lead id metric" "trail trail trail";padding:var(--space-xs)}.dg-ranked-row.dg-dense-row--no-lead{grid-template-areas:"id metric" "trail trail"}.dg-ranked-logo{flex-basis:1.75rem;height:1.75rem;width:1.75rem}.dg-dense-metric__label,.dg-ranked-metric-label{max-width:5.5rem}.dg-dense-dual-rank{min-width:4.25rem}.dg-dense-dual-rank__item{white-space:normal}.dg-team-comparison-board .dg-ranked-row.dg-dense-row{grid-template-areas:"lead id" "state state" "tendencies tendencies" "activity activity";grid-template-columns:auto minmax(0,1fr)}.dg-team-comparison-board .dg-dense-dual-rank{grid-area:lead}.dg-team-comparison-board .dg-ranked-identity{grid-area:id}.dg-team-comparison-state{grid-area:state}.dg-team-comparison-tendencies{grid-area:tendencies}.dg-team-comparison-activity{grid-area:activity}.dg-team-comparison-board .dg-dense-metric{display:none}}
@media (min-width:641px){.dg-team-comparison-board .dg-ranked-row.dg-dense-row{align-items:center;grid-template-areas:none;grid-template-columns:minmax(5rem,auto) minmax(10rem,1fr) minmax(9rem,.8fr) minmax(13rem,1.25fr) minmax(8rem,.7fr)}.dg-team-comparison-board .dg-dense-dual-rank,.dg-team-comparison-board .dg-ranked-identity,.dg-team-comparison-state,.dg-team-comparison-tendencies,.dg-team-comparison-activity{grid-area:auto}}
""".strip()
