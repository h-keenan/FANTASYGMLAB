...
/* Streamlit help= tooltip: make the control look like help, not a stray dot. */
[data-testid="stWidgetLabel"] [data-testid="stTooltipHoverTarget"],[data-testid="stWidgetLabel"] [data-testid="stTooltipIcon"]{align-items:center;display:inline-flex;justify-content:center;min-height:1.25rem;min-width:1.25rem}
[data-testid="stWidgetLabel"] [data-testid="stTooltipIcon"] svg,[data-testid="stWidgetLabel"] [data-testid="stTooltipHoverTarget"] svg{height:1rem!important;opacity:1!important;width:1rem!important}
div[class*="st-key-"][class*="_what_is_auto"] button{background:var(--surface-1)!important;border:var(--border-width-default) solid var(--border-standard)!important;color:var(--text-secondary)!important;font-size:var(--font-size-caption)!important;font-weight:var(--font-weight-metadata)!important;min-height:var(--touch-target-min)!important;padding-inline:var(--space-sm)!important;white-space:nowrap!important;width:auto!important}
div[data-baseweb="popover"],div[data-baseweb="popover"]>div,[data-testid="stSelectboxVirtualDropdown"],div[data-baseweb="popover"] [data-baseweb="menu"]{background:var(--surface-raised)!important;border:var(--border-width-default) solid var(--border-strong)!important;border-radius:var(--radius-panel)!important;box-shadow:var(--shadow-none)!important;color:var(--text-primary)!important}
/* Open menu / listbox — constrained height, branded surface, compact rows */
ul[role="listbox"],div[data-baseweb="popover"] ul[role="listbox"],div[data-baseweb="menu"],[data-testid="stSelectboxVirtualDropdown"] ul{background:var(--surface-raised)!important;border:var(--border-width-default) solid var(--border-strong)!important;border-radius:var(--radius-panel)!important;box-shadow:var(--shadow-none)!important;max-height:min(42vh,18rem)!important;overflow-y:auto!important}
