...
div[class*="st-key-"][class*="_what_is_auto"] button{background:var(--surface-1)!important;border:var(--border-width-default) solid var(--border-standard)!important;color:var(--text-secondary)!important;font-size:var(--font-size-caption)!important;font-weight:var(--font-weight-metadata)!important;min-height:var(--touch-target-min)!important;padding-inline:var(--space-sm)!important;white-space:nowrap!important;width:100%}
