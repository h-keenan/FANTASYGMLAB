...
/* Filters / inputs */
div[data-testid="stTextInput"] input,div[data-testid="stSelectbox"]>div,div[data-testid="stMultiSelect"]>div,div[class*="st-key-player_asset_explorer_"] input,div[class*="st-key-player_asset_explorer_"] [data-baseweb="select"]>div{background:var(--surface-1)!important;border-color:var(--border-standard)!important;border-radius:var(--radius-control)!important;color:var(--text-primary)!important;min-height:var(--touch-target-min)!important}
div[data-testid="stTextInput"] input:focus-visible,div[data-testid="stSelectbox"]>div:focus-within,div[data-testid="stMultiSelect"]>div:focus-within{box-shadow:var(--focus-ring)!important;outline:none!important}
