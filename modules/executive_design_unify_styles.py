...
EXECUTIVE_DESIGN_UNIFY_CSS = (
    ...
    ".st-key-dashboard_workflow{gap:var(--space-md)!important}"
    ".dg-ui-section-header{border-bottom:var(--border-width-default) solid var(--color-border)!important;"
    "margin:var(--space-sm) 0 var(--space-xs)!important;padding:0 0 var(--space-xs)!important}"
    ...
    ".st-key-dashboard_workflow{gap:var(--space-sm)!important}"
    ".dg-ui-section-header--primary .dg-ui-section-title{"
