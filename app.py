...
def _player_quick_view_news_items(row, *, max_items: int = 2) -> list[str]:
    ...
    for item in player_news:
        parts = [
            ...
            _safe_text(item.get("source")).strip(),
        ]
    ...
    if current_page == "my_team":
        ...
        if startup_mode and selected_league_id:
            ...
            render_page_shell(
                page_key="my_team",
                title="My Team",
                subtitle="Roster controls, roles, lineup detail, and day-to-day team management.",
                meta_items=[
        ...
        if startup_team_blocked:
            ...
            if not player_ids:
                ...
                with st.expander("Deep Analysis", expanded=False):
                        ...
                        [
                            {
                                "label": "Strengths",
                                "title": "Roster edges",
                                "items": strengths[:4] or ["No clear roster edge identified yet."],
                                "tone": "strength",
                            },
                            {
                                "label": "Weaknesses",
                                "title": "Pressure points",
                                "items": weaknesses[:4] or ["No clear weakness identified yet."],
                                "tone": "weakness",
                            },
                            {
                                "label": "Risk",
                    ...
                    if _safe_text(team_row.get("archetype_label")):
                        render_archetype_summary(team_row, compact=True, show_header=False)
